...
export default function AboutStory() {
  ...
  return (
    <section id="our-story" className="relative bg-white text-zinc-900 py-20 sm:py-28 px-4 sm:px-6 lg:px-8 border-t border-zinc-100 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-zinc-900 tracking-tight font-sans">
            From Ideas to <span className="text-blue-600">Innovation.</span>
          </h2>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <span className={`text-2xl font-black tracking-widest ${isActive ? 'text-blue-200' : 'text-blue-600'}`}>
                    {item.step}
                  </span>
                  <div className={`p-2 rounded-xl ${isActive ? 'bg-white/20 text-white' : 'bg-white text-zinc-700 shadow-sm'}`}>
        ...
        <div className="relative bg-gradient-to-br from-zinc-900 via-zinc-950 to-black text-white p-8 sm:p-12 rounded-3xl border border-zinc-800 shadow-2xl overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="lg:col-span-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-blue-500/20 text-blue-400 text-xs font-bold tracking-widest uppercase mb-4 border border-blue-500/30">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  {storySteps[activeStep].highlights.map((h, i) => (
                    <span
                      key={i}
                      className="px-4 py-2 rounded-xl bg-white/10 text-white text-xs font-semibold border border-white/10 backdrop-blur-md"
                    >
                      ✓ {h}
                    </span>
                  ))}
              ...
              <div className="lg:col-span-4 flex flex-col items-center lg:items-end justify-center">
                <div className="w-24 h-24 rounded-full border-4 border-blue-500/30 flex items-center justify-center relative">
                  ...
                  <div className="absolute -inset-1 rounded-full border-2 border-blue-400 animate-ping opacity-25" />
                </div>
                <span className="mt-4 text-xs font-bold tracking-widest text-zinc-400 uppercase">
                  Execution Phase
                </span>
              </div>
            </motion.div>
