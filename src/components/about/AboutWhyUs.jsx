      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-zinc-900 tracking-tight font-sans">
            Why Nex <span className="text-blue-600">Alliance.</span>
          </h2>
          <p className="mt-4 text-base sm:text-lg text-zinc-600">
            We don't just build software. We build solutions around your business.
          </p>
        </div>
          ...
          {whyReasons.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white p-8 rounded-3xl border border-zinc-200/90 shadow-xl shadow-zinc-200/40 hover:border-blue-500 hover:shadow-blue-500/10 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  ...
                  <h3 className="text-xl font-bold text-zinc-900 font-sans group-hover:text-blue-600 transition-colors">
                    {item.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-zinc-100 text-xs font-extrabold text-blue-600 tracking-wider uppercase">
                  Pillar 0{idx + 1}
                </div>
              </motion.div>
            );
