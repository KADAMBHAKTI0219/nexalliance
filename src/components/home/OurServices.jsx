...
export default function OurServices() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 2. Synchronized Card Entrance Reveal: Each card illuminates right as glowing line reaches it
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center relative">
        ...
        {/* 100% Ultra-Smooth Continuous Curved SVG Trail Line (NO Sharp Corners / Kinks) */}
        <div aria-hidden="true" className="hidden lg:block absolute top-[210px] bottom-[80px] inset-x-0 pointer-events-none z-0">
          ...
          >
            ...
            {/* Background Trail Guide (Subtle Continuous Wave) */}
            <path
                ...
                >
                  <div className="relative group rounded-[28px] bg-white border border-zinc-200/90 shadow-md hover:shadow-xl p-6 sm:p-8 flex flex-col justify-between min-h-[300px] transition-all duration-300 overflow-hidden transform-gpu z-10">
                    ...
                    <div className="absolute bottom-0 right-0 z-20">
                      <div
                        className="relative bg-[#f8fafc] rounded-tl-2xl rounded-br-[28px] p-1.5 sm:p-2 pt-2 pl-2"
                        style={{ '--notch-bg': '#ffffff' }}
                      >
