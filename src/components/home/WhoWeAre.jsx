    ...
    <section id="whoweare" className="relative w-full py-20 sm:py-28 bg-gradient-to-b from-[#3b5da6]/10 via-[#25294a]/5 to-[#3b5da6]/10 border-y border-[#3b5da6]/20 text-[#25294a] overflow-hidden select-none">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col items-center">
          ...
          >
            Nexalliance is a technology and digital solutions company focused on building meaningful digital experiences, intelligent systems, and scalable enterprise software.
          </motion.p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-6 mt-6">
              <p className="md:col-span-8 text-sm sm:text-base text-zinc-600 leading-relaxed font-normal">
                Nexalliance delivers innovative tech solutions across diverse sectors — from ambitious startups to established global enterprises — meeting every unique challenge with precision.
              </p>
